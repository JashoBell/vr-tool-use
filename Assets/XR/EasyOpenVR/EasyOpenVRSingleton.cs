...
namespace BOLL7708
{
    ...
    public sealed class EasyOpenVRSingleton
    {
         ...
         */
        private static EasyOpenVRSingleton _instance = null;
        ...
        {
            get { return _instance ??= new EasyOpenVRSingleton(); }
        }
        #region setup
        ...
        #region tracking
        public TrackedDevicePose_t[] GetDeviceToAbsoluteTrackingPose(ref TrackedDevicePose_t[] trackedDevicePoses, ETrackingUniverseOrigin origin = ETrackingUniverseOrigin.TrackingUniverseStanding)
        {
            try{
        ...
        public uint[] GetIndexesForTrackedDeviceClass(ETrackedDeviceClass @class)
        {
            ...
            {
                if (GetTrackedDeviceClass(i) == @class) result.Add(i);
            }
        ...
        public float GetRenderTargetForCurrentApp()
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Render scale: {scale}");
            return scale;
        }
        ...
        public static class UnityUtils
        {
            ...
            public static HmdQuaternion_t MatrixToRotation(ref HmdMatrix34_t m)
            {
                // x and y are reversed to flip the rotation in the X axis, to convert OpenVR to Unity
                var q = new HmdQuaternion_t
                {
            ...
            public static HmdVector3_t MatrixToPosition(ref HmdMatrix34_t m)
            {
                // m11 is reversed to flip the Z axis, to convert OpenVR to Unity
                var v = new HmdVector3_t
                {
