...
namespace UXF
{
    ...
    public abstract class Tracker : MonoBehaviour
    {
        ...
        { 
            get
            {
                if(updateType != TrackerUpdateType.fastUpdate & updateType != TrackerUpdateType.buttonInput & updateType != TrackerUpdateType.eyeTracker){
        ...
        public void RecordRow()
        {
            ...
            if(updateType != TrackerUpdateType.fastUpdate || updateType != TrackerUpdateType.buttonInput){
    ...
    {
        LateUpdate, FixedUpdate, Manual, fastUpdate, buttonInput, eyeTracker
    }
}