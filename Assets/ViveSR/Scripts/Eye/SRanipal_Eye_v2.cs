    ...
    namespace anipal
    {
        namespace Eye
        {
            public static class SRanipal_Eye_v2
            {
                ...
                /// <param name="eye_data">ViveSR.anipal.Eye.EyeData_v2. </param>
                /// <returns></returns>
                public static bool GetPupilPosition(EyeIndex eye, out Vector2 position, EyeData_v2 eye_data)
                {
                    bool valid = false;
                    if (SRanipal_Eye_Framework.Status == SRanipal_Eye_Framework.FrameworkStatus.WORKING)
                    {
                        ...
                        position = valid ? new Vector2(eyeData.pupil_position_in_sensor_area.x * 2 - 1,
